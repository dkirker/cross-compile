...
StateInput::StateInput(GameState *state)
{
    ...
    m_keymap->registerKey(KeyStroke(SDLK_q, KMOD_NONE), key_quit);
    m_keymap->registerKey(KeyStroke(SDLK_BACKQUOTE, KMOD_NONE), key_console);
    m_keymap->registerKey(KeyStroke(SDLK_h, KMOD_NONE), key_help);
    m_keymap->registerKey(KeyStroke(SDLK_o, KMOD_NONE), key_menu);
    m_keymap->registerKey(KeyStroke(SDLK_t, KMOD_NONE),
